...
const reviewReplyRoutes = require("./routes/reviewReplyRoutes");
...
app.get("/api/payments/swychr/webhook", handleSwychrRedirect);
app.post("/api/payments/swychr/webhook", handleSwychrWebhook);
app.use("/api/reviews", reviewReplyRoutes);
