        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-text-muted mb-4">
              Our mission is to empower beauty entrepreneurs by providing a
              robust platform to showcase their talents, manage their business,
              and connect with a wider audience. We aim to simplify the process
              for clients to discover, book, and review beauty services,
              ensuring a seamless and trustworthy experience for everyone.
            </p>
            <p className="text-text-muted">
              We believe in the power of community and strive to build a
              supportive ecosystem where beauty professionals can thrive and
