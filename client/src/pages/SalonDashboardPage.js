    ...
    <div>
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-text-main">
          Welcome back, {salonData?.name || user?.name}!
        </h1>
        <p className="text-text-muted">
          Here's a summary of your salon's activity today.
        </p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white p-6 rounded-lg shadow-sm">
          <p className="text-sm text-text-muted">Today's Bookings</p>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm">
          <p className="text-sm text-text-muted">Total Earnings (Month)</p>
          <p className="text-3xl font-bold text-gray-400">...</p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-sm">
          <p className="text-sm text-text-muted">New Reviews</p>
          <p className="text-3xl font-bold text-gray-400">...</p>
        </div>
      </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <span>Add a Walk-in Booking</span>
              </Link>
              <Link
