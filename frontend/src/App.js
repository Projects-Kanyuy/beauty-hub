  ...
  return (
    <div className="font-sans">
      ...
      <Routes>
        ...
        <Route path="/login" element={!user ? <LoginPage /> : <Navigate to={user.role === 'salon_owner' ? '/salon-owner/dashboard' : '/dashboard'} replace />} />
        <Route path="/register" element={!user ? <RegisterPage /> : <Navigate to={user.role === 'salon_owner' ? '/salon-owner/dashboard' : '/dashboard'} replace />} />
